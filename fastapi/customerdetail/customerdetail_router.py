...
def customerdetail(customer_id: int, order: str = 'create_date-desc', keyword: str = '', db: Session = Depends(get_db)):
    customerdetails = customerdetail_crud.customer_customerdetail(
        db, customer_id=customer_id, order=order, keyword=keyword)
    return {'customer_list': customerdetails}
